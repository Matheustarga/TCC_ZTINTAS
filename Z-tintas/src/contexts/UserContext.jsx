...
export const AuthProvider = ({children}) => {
    ...
    //Quando o componente é renderizado, busca no localStorage usuario atual, se não tiver nenhum define como Visitante
    useEffect(() =>{
    ...
    //função para receber as informações login, e guardar no localStorage
    const login = (data) => {
